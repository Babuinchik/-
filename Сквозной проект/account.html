...
<body>
  <div class="header">
    ...
    <a href="account.html"><img class = "profile" src = "Img/profile icon.png"></a>
  </div>
  <div class="content">
    <img class="mainimg" src="Img/Main page.png">
    <div class = "Data">
      <p>Данные</p>
      <a href = "index.html"><button class = "exit">Выйти из аккаунта</button></a>
    </div>
    <div class = "Bookingacc">
      <p>Забронированные столы</p>
    </div>
  </div>
</body>
  <footer>
